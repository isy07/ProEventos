...
//  * @param id Precisa passar o PalestranteId ou o EventoId dependendo de sua Origem
//  * @returns Observable<RedeSocia[]>
//  */
...
//  * @param origem Precisa passar a palavra 'palestrante' ou 'evento' -Escrito em minusculo
//  * @param id Precisa passar o PalestranteId ou o EventoId dependendo de sua Origem
//  * @param redeSocialId precisa usar o id da RedeSocial[].
